      ...
      <div class="container">
          ...
          <div class="col-md-4 d-flex">
          	<div class="info bg-white p-4">
	            <p align="center"><strong>Upload</strong> </p>
	          </div>
          </div>
          <div class="col-md-4 d-flex">
          ...
          <div class="col-md-10 order-md-last d-flex">
           ...
           <?php } ?>
            <div class="form-group">
                <input type="text" class="form-control" name="invoice" placeholder="Product Invoice" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="file" class="form-control" id="prdImage" name="imageprd[]" multiple="multiple"  required>
                ...
                <div class="form-group"> 
                <input type="text" class="form-control" name="cat" placeholder="Mention Category" required>
              </div>
                 <div class="form-group"> 
              ...
              <div class="form-group"> 
               <select name="sale" id="select" class="form-control">
                ...
                <input type="text" class="form-control" name="sprice" placeholder="Enter Product Sale Price %">
              </div>
                 <div class="form-group"> 
              ...
              <div class="form-group">
                <input type="submit" value="Upload Product" name="upload" class="btn btn-primary py-3 px-5 up">
              </div>
            </form>
